...
?>
    <li class="<?= implode(' ', $classes) ?>"><a href="<?= ($href) ?>"><i class="fa fa-chevron-left" aria-hidden="true"></i></a></li>
<?php
        /**
...
?>
    <li class="<?= implode(' ', $classes) ?>"><a href="<?= ($href) ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>
</ul>
<?php
    }
