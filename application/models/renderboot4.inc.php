...
if ($pages > 1 || $alwaysShowPagination === true) {
    ...
    <ul class="<?= implode(' ', $classes) ?>">
        ...
        ?>
        <li class="<?= implode(' ', $classes) ?>"><a href="<?= ($href) ?>" class="page-link" style="color: <?php echo $bgcolor;?>;"><span aria-hidden="true">&laquo;</span>
        ...
        if (!$clean) {
            ...
            for ($x = 0; $x < $leading; ++$x) {
                ...
                ?>
                <li class="page-item"><a data-pagenumber="<?= ($current + $x - $leading) ?>" class="page-link" style="color: <?php echo $bgcolor;?>;" href="<?= ($href) ?>"><?= ($current + $x - $leading) ?></a></li>
                <?php
            }

            // print current page
            ?>
            <li class="page-item active"><a data-pagenumber="<?= ($current) ?>" class="page-link" style="background-color: <?php echo $bgcolor;?>;border-color: <?php echo $bgcolor;?>;color: <?php echo $fontcolor;?>;" href="#"><?= ($current) ?></a></li>
            <?php
            ...
            for ($x = 0; $x < $trailing; ++$x) {
             ...
             ?>
             <li class="page-item"><a data-pagenumber="<?= ($current + $x + 1) ?>" class="page-link" href="<?= ($href) ?>" style="color: <?php echo $bgcolor;?>;"><?= ($current + $x + 1) ?></a></li>
             <?php
         }
     }
        ...
        ?>
        <li class="<?= implode(' ', $classes) ?>"><a href="<?= ($href) ?>" class="page-link" style="color: <?php echo $bgcolor;?>;"><span aria-hidden="true">&raquo;</span>
