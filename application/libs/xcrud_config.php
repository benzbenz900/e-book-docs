...
class Xcrud_config
{
    ...
    // theme and language
    public static $theme = 'strap'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
    ...
    public static $email_from_name = 'lnwPHP.in.th cii3.net'; // email from name
