<?php
function modifier_ago($datetime_string, $full = false)
{
...
function modifier_name($value, $fieldname, $primary, $row, $xcrud){
    if (!defined('BASE_URL') && !defined('THEME')) {
        include '../config/config.php';
    }
    
    return '<a class="p-0 text-white font-weight-bold text-decoration-none" href="'.BASE_URL.'main/detail/'.$primary.'/">'.$value.'</a>';
}