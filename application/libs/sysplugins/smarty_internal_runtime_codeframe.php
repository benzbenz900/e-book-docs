...
class Smarty_Internal_Runtime_CodeFrame
{
    ...
    public function create(
        ...
        $output = "<?php\n";
        $output .= "/* <!-- ".base64_decode('UElQZSBNQ1YgJiBTbWFydHkgSEhWTSBCeSBsbndQSFAuaW4udGggJiBjaWkzLm5ldA==')." -->  */\n\n\n/* ".base64_decode('TW9kaWZ5IEZvciBQSVBlIE1WQyBISFZNIEJ5IFNtYXJ0eSB2ZXJzaW9u')." {$properties[ 'version' ]}, created on " . strftime("%Y-%m-%d %H:%M:%S") .
