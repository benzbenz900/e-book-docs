...
class Xcrud
{
        ...
        if ($total > $limit)
        {
            ...
            if ($pages > $numpos)
            {
                ...
                if ($curent <= $numlr + 3)
                {
                    ...
                    $html .= '<li class="' . $this->theme_config('pagination_dots') . '"><a class="page-link" href="#">&#133;</a></li>';
    ...
    protected function _pagination_item($i, $curent, $limit)
    {
        $limit1 = $i * $limit - $limit;
        if ($i == $curent)
            return '<li class="' . $this->theme_config('pagination_active') . '"><a class="page-link" href="#">' . $i . '</a></li>';
        else
        {
    ...
    protected function create_file_folders($path)
    {
        ...
        {
            self::error('File path is incorrect!'.json_encode($path));
        }
    }
